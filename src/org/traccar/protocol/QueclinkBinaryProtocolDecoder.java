...
public class QueclinkBinaryProtocolDecoder extends BaseProtocolDecoder {
    ...
    private static final int MSG_RSP_LCB = 3;
    private static final int MSG_RSP_GEO = 8;
    private static final int MSG_RSP_COMPRESSED = 100;
    ...
    private static final int MSG_EVT_BPL = 6;
    private static final int MSG_EVT_VGN = 45;
    private static final int MSG_EVT_VGF = 46;
    private static final int MSG_EVT_UPD = 15;
    private static final int MSG_EVT_IDF = 17;
    private static final int MSG_EVT_GSS = 21;
    private static final int MSG_EVT_GES = 26;
    private static final int MSG_EVT_GPJ = 31;
    private static final int MSG_EVT_RMD = 35;
    private static final int MSG_EVT_JDS = 33;
    private static final int MSG_EVT_CRA = 23;
    private static final int MSG_EVT_UPC = 34;
    ...
    private Position decodeEvent(Channel channel, SocketAddress remoteAddress, ByteBuf buf) {
        ...
        switch (type) {
            case Gl200BinaryProtocolDecoder.MSG_EVT_BPL:
                buf.readUnsignedShort(); // backup battery voltage
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_VGN:
            case Gl200BinaryProtocolDecoder.MSG_EVT_VGF:
                buf.readUnsignedShort(); // reserved
                buf.readUnsignedByte(); // report type
                buf.readUnsignedInt(); // ignition duration
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_UPD:
                buf.readUnsignedShort(); // code
                buf.readUnsignedByte(); // retry
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_IDF:
                buf.readUnsignedInt(); // idling duration
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_GSS:
            ...
            case MSG_EVT_JDS:
                ...
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_CRA:
                buf.readUnsignedByte(); // crash counter
                break;
            case Gl200BinaryProtocolDecoder.MSG_EVT_UPC:
    ...
    private static final int MSG_INF_GPS = 2;
    private static final int MSG_INF_CID = 4;
    private static final int MSG_INF_CSQ = 5;
    private static final int MSG_INF_VER = 6;
    private static final int MSG_INF_BAT = 7;
    private static final int MSG_INF_TMZ = 9;
    private static final int MSG_INF_GIR = 10;

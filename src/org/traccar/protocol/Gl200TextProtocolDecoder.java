...
public class Gl200TextProtocolDecoder extends BaseProtocolDecoder {
    ...
    private Object decodePna(Channel channel, SocketAddress remoteAddress, String sentence, String type) {
        Parser parser = new Parser(PATTERN_PNA, sentence);
        if (!parser.matches()) {
            return null;
        }
    ...
    private Object decodeStt(Channel channel, SocketAddress remoteAddress, String sentence) {

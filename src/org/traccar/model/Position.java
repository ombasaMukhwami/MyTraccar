...
public class Position extends Message {
    ...
    public static final String KEY_VERSION_P = "protocolVersion";
    ...
    public static final String KEY_VALID_ANTENNA_POWERE = "validAntennaPower";
    ...
    public static final String ALARM_BATTERY_CUT = "batteryDisconnected";
    ...
    public static final String ALARM_UNAUTHORIZED_DRIVER = "unAuthorizedDriver";
    public static final String ALARM_DRIVER_AUTHORIZATION = "driverAuthorizing";
    ...
    public static final String ALARM_GLASS_BROKEN = "glassBroken";
    public static final String ALARM_INTRUSION = "intrusion";
